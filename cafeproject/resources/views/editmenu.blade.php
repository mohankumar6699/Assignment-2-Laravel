...
@section('admincontent')
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> Update Menu</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="/adminpanel">Home</a></li>
                        <li><i class="fa fa-laptop"></i>Update Menu</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="container">
                <form class="form-horizontal" role="form" action="{{route('menu.update')}}" method="GET">
                    @csrf
                    <input type="hidden" name="id" value="{{$menu->id}}">
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="menu_name">Menu Name:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{$menu->menu_name}}" id="menu_name" placeholder="Enter menu name" name="menu_name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{$menu->menu_desc}}" id="menu_desc" placeholder="Enter menu description" name="menu_desc">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{$menu->menu_price}}" id="menu_price" placeholder="Enter menu price" name="menu_price">
                        </div>
                    </div>
